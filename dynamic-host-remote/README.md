...
`app2` that exposes the remote component can be deployed anywhere. The build
output of `app1` has a `remoteHosts.js` file that points to the deployment
of `app2`. This can be changed at runtime.
